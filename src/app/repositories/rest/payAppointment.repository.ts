  ...
  private parseInput(
    ...
    return {
      ...
      axional: {
        ...
        noCliente: axional.clientFirstName.toUpperCase(),
        apCliente: axional.clientLastName.toUpperCase(),
        amCliente: axional.clientSecondLastName?.toUpperCase() ?? '',
        diCliente: '',
        rsCliente: '',
        emCliente: '',
        ngCliente: '',
        ...
        noPaciente: axional.patientFirstName.toUpperCase(),
        apPaciente: axional.patientLastName.toUpperCase(),
        amPaciente: axional.patientSecondLastName?.toUpperCase() ?? '',
