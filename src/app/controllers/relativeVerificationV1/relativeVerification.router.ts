...
export class RelativeVerificationV1Router {
  ...
  private readonly relativeVerificationController: IRelativeVerificationController;
  ...
  constructor(private readonly fastify: FastifyInstance) {
    this.relativeVerificationController = RelativeVerificationControllerBuilder.build();
  ...
  registerRouter(): void {
    this.fastify.route({
      ...
      url: `${this.version}/patients/relatives/verify`,
      ...
      handler: this.relativeVerificationController.handle.bind(this.relativeVerificationController),
    });
  }
}
