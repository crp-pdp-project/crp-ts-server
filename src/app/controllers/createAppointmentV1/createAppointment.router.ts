...
import type { ICreateAppointmentController } from './createAppointment.controller';
import { CreateAppointmentControllerBuilder } from './createAppointment.controller';

export class CreateAppointmentV1Router {
  ...
  constructor(private readonly fastify: FastifyInstance) {
    this.createAppointmentController = CreateAppointmentControllerBuilder.build();
