...
import type { ICancelAppointmentController } from './cancelAppointment.controller';
import { CancelAppointmentControllerBuilder } from './cancelAppointment.controller';

export class CancelAppointmentV1Router {
  private readonly version: string = '/v1';
  private readonly cancelAppointmentController: ICancelAppointmentController;
  ...
  constructor(private readonly fastify: FastifyInstance) {
    this.cancelAppointmentController = CancelAppointmentControllerBuilder.build();
  ...
  registerRouter(): void {
    this.fastify.route({
      ...
      handler: this.cancelAppointmentController.handle.bind(this.cancelAppointmentController),
    });
  }
}
