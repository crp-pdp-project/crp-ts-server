...
import type { IPayAppointmentController } from './payAppointment.controller';
import { PayAppointmentControllerBuilder } from './payAppointment.controller';

export class PayAppointmentV1Router {
  private readonly version: string = '/v1';
  private readonly payAppointmentController: IPayAppointmentController;
  ...
  constructor(private readonly fastify: FastifyInstance) {
    this.payAppointmentController = PayAppointmentControllerBuilder.build();
  ...
  registerRouter(): void {
    this.fastify.route({
      ...
      url: `${this.version}/patients/:fmpId/appointments/:appointmentId/pay`,
      ...
      handler: this.payAppointmentController.handle.bind(this.payAppointmentController),
    });
  }
}
