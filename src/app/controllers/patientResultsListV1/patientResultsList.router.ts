...
import type { IPatientResultsListController } from './patientResultsList.controller';
import { PatientResultsListControllerBuilder } from './patientResultsList.controller';

export class PatientResultsListV1Router {
  private readonly version: string = '/v1';
  private readonly patientResultsListController: IPatientResultsListController;
  ...
  constructor(private readonly fastify: FastifyInstance) {
    this.patientResultsListController = PatientResultsListControllerBuilder.build();
  ...
  registerRouter(): void {
    this.fastify.route({
      ...
      url: `${this.version}/patients/:fmpId/results`,
      ...
      handler: this.patientResultsListController.handle.bind(this.patientResultsListController),
    });
  }
}
