...
import type { ISpecialtiesListController } from './specialtiesList.controller';
import { SpecialtiesListControllerBuilder } from './specialtiesList.controller';

export class SpecialtiesListV1Router {
  ...
  constructor(private readonly fastify: FastifyInstance) {
    this.specialtiesListController = SpecialtiesListControllerBuilder.build();
