...
import type { IPayHealthInsuranceController } from './payHealthInsurance.controller';
import { PayHealthInsuranceControllerBuilder } from './payHealthInsurance.controller';

export class PayHealthInsuranceV1Router {
  private readonly version: string = '/v1';
  private readonly payHealthInsuranceController: IPayHealthInsuranceController;
  ...
  constructor(private readonly fastify: FastifyInstance) {
    this.payHealthInsuranceController = PayHealthInsuranceControllerBuilder.build();
  ...
  registerRouter(): void {
    this.fastify.route({
      ...
      url: `${this.version}/health-insurances/pay`,
      ...
      handler: this.payHealthInsuranceController.handle.bind(this.payHealthInsuranceController),
    });
  }
}
