...
import type { IPatientRelativesController } from './patientRelatives.controller';
import { PatientRelativesControllerBuilder } from './patientRelatives.controller';

export class PatientRelativesV1Router {
  ...
  constructor(private readonly fastify: FastifyInstance) {
    this.patientRelativesController = PatientRelativesControllerBuilder.build();
