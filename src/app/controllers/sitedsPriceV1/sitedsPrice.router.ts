...
import type { ISitedsPriceController } from './sitedsPrice.controller';
import { SitedsPriceControllerBuilder } from './sitedsPrice.controller';

export class SitedsPriceV1Router {
  private readonly version: string = '/v1';
  private readonly sitedsPriceController: ISitedsPriceController;
  ...
  constructor(private readonly fastify: FastifyInstance) {
    this.sitedsPriceController = SitedsPriceControllerBuilder.build();
  ...
  registerRouter(): void {
    this.fastify.route({
      ...
      url: `${this.version}/patients/:fmpId/siteds`,
      ...
      handler: this.sitedsPriceController.handle.bind(this.sitedsPriceController),
    });
  }
}
