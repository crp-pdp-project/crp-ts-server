...
import type { IDeletePatientAccountController } from './deletePatientAccount.controller';
import { DeletePatientAccountControllerBuilder } from './deletePatientAccount.controller';

export class DeletePatientAccountV1Router {
  ...
  constructor(private readonly fastify: FastifyInstance) {
    this.deletePatientAccountController = DeletePatientAccountControllerBuilder.build();
